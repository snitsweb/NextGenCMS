...
class TestSectionController(BaseTestCase):
    ...
    def test_create_section(self):
        ...
        response = self.client.open(
            '/MATEUSZTEPLICKI/foto_portfolio_project/1.1.0/subpage/{id_subpage}/section'.format(id_subpage=56),
            method='POST',
    ...
    def test_delete_image_from_section(self):
        ...
        """
        response = self.client.open(
            '/MATEUSZTEPLICKI/foto_portfolio_project/1.1.0/subpage/{id_subpage}/section/{id_section}/images/{id_image}'.format(id_subpage=56, id_section=56, id_image=56),
            method='DELETE')
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))
    ...
    def test_delete_section_by_id(self):
        ...
        """
        response = self.client.open(
            '/MATEUSZTEPLICKI/foto_portfolio_project/1.1.0/subpage/{id_subpage}/section/{id_section}'.format(id_subpage=56, id_section=56),
            method='DELETE')
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))
    ...
    def test_patch_image_order(self):
        ...
        body = [[ 2, 1, 4, 3 ]]
        response = self.client.open(
            '/MATEUSZTEPLICKI/foto_portfolio_project/1.1.0/subpage/{id_subpage}/section/{id_section}/images'.format(id_subpage=56, id_section=56),
            method='PATCH',
            data=json.dumps(body),
            content_type='application/json')
        self.assert200(response,
    ...
    def test_patch_section_value(self):
        ...
        body = None
        response = self.client.open(
            '/MATEUSZTEPLICKI/foto_portfolio_project/1.1.0/subpage/{id_subpage}/section/{id_section}/value'.format(id_subpage=56, id_section=56),
            method='PATCH',
            data=json.dumps(body),
            content_type='application/json')
        self.assert200(response,
