...
from photo_portfolio.models.social import Social  # noqa: E501
...
class TestSocialController(BaseTestCase):
    ...
    def test_create_connection(self):
        ...
        response = self.client.open(
            '/MATEUSZTEPLICKI/foto_portfolio_project/1.0.0/social',
            method='POST',
            headers=headers,
    ...
    def test_delete_social_by_id(self):
        ...
        """
        response = self.client.open(
            '/MATEUSZTEPLICKI/foto_portfolio_project/1.0.0/social/{id}'.format(id=56),
            method='DELETE')
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))
