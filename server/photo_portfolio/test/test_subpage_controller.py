...
from photo_portfolio.models.subpage import Subpage  # noqa: E501
from photo_portfolio.models.subpage_body import SubpageBody  # noqa: E501
from photo_portfolio.models.subpage_id_body import SubpageIdBody  # noqa: E501
...
class TestSubpageController(BaseTestCase):
    ...
    def test_create_subpage(self):
        ...
        response = self.client.open(
            '/MATEUSZTEPLICKI/foto_portfolio_project/1.0.0/subpage',
            method='POST',
    ...
    def test_delete_subpage(self):
        ...
        """
        response = self.client.open(
            '/MATEUSZTEPLICKI/foto_portfolio_project/1.0.0/subpage/{id}'.format(id=56),
            method='DELETE')
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))
